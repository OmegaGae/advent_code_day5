...
# File Name : 2021_day4.py

# Purpose :

# Creation Date : 05-01-2022

# Last Modified : Tue Jan 11 09:25:52 2022
...
class Bingo:
    ...
    def is_board_full(self):
        ...
        for ind_board, _ in enumerate(self.all_boards):
            ...
            if len(self.repertory.get(ind_board, 0)) >= len(self.all_boards[0][0]):
        ...
        while True:
            ...
            try:
                ...
                if state_row:
                    ...
                    return (
                        self.sum_winner_board(ind_board, rep_rand_nbers) * is_winner_row
                    )
                    ...
                    return (
                        self.sum_winner_board(ind_board, rep_rand_nbers)
                        * is_winner_cols
                    )
                else:
                    continue
...
if __name__ == "__main__":
    input_dum = edit.Editfile("input_day4.txt").read()
    bingo_game = Bingo(input_dum)
    print(bingo_game.winner_board())
